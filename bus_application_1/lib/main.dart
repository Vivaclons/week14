import 'package:bus_application_1/busLine.dart';
import 'package:bus_application_1/passenger.dart';
import 'package:bus_application_1/widgets/Button.dart';
import 'package:bus_application_1/widgets/list.dart';
import 'package:bus_application_1/widgets/listTitle.dart';
import 'package:bus_application_1/widgets/textField.dart';
...
class _HomeState extends State<Home> {
  List<BusLine> busList = [
    BusLine(
        ...
        icon: Image.asset('assets/images/bus1.jpg')),
    BusLine(
        name: 'End2End Test1',
        from: 'Город X',
        to: 'Сарыагаш',
